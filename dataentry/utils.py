...
def get_all_custom_models():
    default_models = ['ContentType', 'Session', 'LogEntry', 'Group', 'Permission', 'Upload', 'List', 'Subscriber','Email', 'Sent', 'EmailTracking', 'CompressImage', 'StockData'] # exclude default models or custom models
